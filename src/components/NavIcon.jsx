...
const PATHS = {
  ...
  // Barras escalonadas: el gesto universal de una línea de tiempo (mismo dibujo
  // que el acceso al cronograma de un sprint).
  timeline: <path d="M4 7h9M8 12h11M4 17h7" />,
