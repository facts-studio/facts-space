...
export async function requestVacation({ startDate, endDate, note = "", type = "vacaciones" }) {
  ...
  // Un colaborador no lleva sus ausencias con nosotros: la UI no le enseña el
  // formulario, y la ruta también se cierra.
  if (isColaborador(me)) return { ok: false, error: "Tus ausencias no se gestionan desde el portal." };
